...
import com.tedchen.play.common.logger.Log;
...
public class BluetoothCtrlService {
     ...
     */
    public BluetoothCtrlService(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        BluetoothCtrlService.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            UUID uuid = GlobalConfig.getInstance().getBlueUuid();
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothCtrlService.this) {
                        switch (mState) {
                            case STATE_LISTEN:
