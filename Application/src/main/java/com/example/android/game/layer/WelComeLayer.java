package com.example.android.game.layer;

import android.os.AsyncTask;
import android.os.SystemClock;
import android.view.MotionEvent;

import com.example.android.game.base.BaseLayer;
...
public class WelComeLayer extends BaseLayer {
	...
	private void loadBGM() {
		engine.playSound(getContext(), com.example.android.bluetoothchat.R.raw.start, true);
	}
//设置按钮点击跳转到游戏页
	@Override
	public boolean ccTouchesEnded(MotionEvent event) {
		if(CommonUtil.isClicke(event, this, this.getChildByTag(TAG_START))){
			engine.playEffect(getContext(), com.example.android.bluetoothchat.R.raw.onclick);
